...
public class FieldOfResearchControllerTest {
    ...
    @Test
    public void FieldOfResearchProfile() throws Exception {
        ...
        mockMvc.perform(get("/fieldOfResearch")
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
        ).andDo(print())
                .andExpect(status().is3xxRedirection())
    ...
    @Test
    public void ProfessorPost() throws Exception {
        mockMvc.perform(post("/register")
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("role", "PROFESSOR")
                .param("username", "testName")
